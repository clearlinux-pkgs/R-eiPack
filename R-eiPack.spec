...
Version  : 0.2.1
Release  : 31
URL      : https://cran.r-project.org/src/contrib/eiPack_0.2-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/eiPack_0.2-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589780818
