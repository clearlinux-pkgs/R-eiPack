...
Version  : 0.1.7
Release  : 2
URL      : https://cran.r-project.org/src/contrib/eiPack_0.1-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/eiPack_0.1-7.tar.gz
Summary  : eiPack: Ecological Inference and Higher-Dimension Data
Group    : Development/Tools
License  : GPL-2.0+
Requires: R-eiPack-lib
Requires: R-coda
Requires: R-msm
...
export LANG=C
export SOURCE_DATE_EPOCH=1530481453
